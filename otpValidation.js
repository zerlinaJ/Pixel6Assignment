...
function validateOTP() {
  ...
  if (random === parseInt(otp.value)) {
    ...
    if (attempt === 3) {
      ...
      setTimeout(function () { window.location.assign("LoginUnsuccessful.html") }, 1000);
    }
    return false;
  }
...
function validate(e){
  ...
  if(/[a-zA-Z ~`@!#$%\^&*+=\-\[\]\\';,/{}|\\":<>\?]/g.test(target.value)){
    document.getElementById("message").innerHTML = "Alphabets and special characters not allowed";
  }
